      ...
      <div class="main-menu menu-static menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            {{-- Category Management --}}
            <li class=" nav-item"><a href="#"><i class="fa fa-book"></i><span class="menu-title" data-i18n="nav.dash.main">Manage Category</a>
            ...
            {{-- Report Dashboard --}}
            <li class="nav-item"><a href="#"><i class="fa fa-bar-chart"></i><span class="menu-title" data-i18n="nav.dash.main">Report Dashboard</a>
                <ul class="menu-content">
            ...
            <li class="nav-item"><a href="#"><i class="fa fa-user"></i><span class="menu-title" data-i18n="nav.dash.main">User Management</a>
                <ul class="menu-content">
                        <li>
