            ...
            <tbody>
                @for ($i = 1; $i <= 6; $i++)
                    <tr style="padding: 0; margin: 0" class="item-row">
                        <td style="padding: 0; margin: 0; font-size: 10">{{$i}}</td>
                        <td style="padding: 0; margin: 0">
                            <h6 style="padding: 0; margin: 0; font-weight: 200">Gold pendant necklace with diamond 24 Karat</h6>
                        </td>
                ...
                <tr>
                    <td style="text-align: right; font-size: 10px" colspan="2">Total</td><td></td>
                </tr>
                <tr>
                    <td style="text-align: right; font-size: 10px" colspan="2">PPN</td><td></td>
                </tr>
                <tr>
                    <td style="text-align: right; font-size: 10px" colspan="2">Total + PPN</td><td></td>
                </tr>
            </table>
        </tr>
    </table>
